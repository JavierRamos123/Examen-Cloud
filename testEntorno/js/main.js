...
function analizarContrasenia(){
    ...
    if(password.value === null || password.value === '' ){
        ...
        var msgVacio = document.getElementById("mensajePasswordEmpty");
        msgVacio.innerText = "No se ha ingresado contraseña. Por favor, ingrese una contraseña";
    }
    else{
...
function consecutivosNumericos(elem1,elem2){
   ...
   for (var i=0; i<elem1.length; i++){
        var unicodeChar = elem1.charCodeAt(i);
        if(unicodeChar >= 48 && unicodeChar <= 57){
            if(elem1.charCodeAt(i++) >= 48 && elem1.charCodeAt(i++) <= 57){
                return true;
            }
        }else{
            return false;
...
function mostrarCantidadesAnalisis(infoPassword){
 ...
 document.getElementById('cantTotalCaracteres').innerText= (infoPassword.cantTotalCaracteres);;
 ...
 document.getElementById('secTipoNums').innerHTML= (infoPassword.tipoNumeros);
 document.getElementById('secTipoLetras').innerHTML= (infoPassword.tipoLetras);
 document.getElementById('secTipoEspeciales').innerHTML= (infoPassword.tipoEspeciales);
 document.getElementById('porcentajeNums').style.width = (infoPassword.porcNumeros);
 document.getElementById('porcentajeLetras').style.width = (infoPassword.porcLetras);
 document.getElementById('porcentajeEspeciales').style.width = (infoPassword.porcEspeciales);
}
